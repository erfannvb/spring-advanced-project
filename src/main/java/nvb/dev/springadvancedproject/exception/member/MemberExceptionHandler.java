...
public class MemberExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public ResponseEntity<ErrorResponseModel> handleMemberNotFoundException(RuntimeException ex) {
    ...
    @ExceptionHandler(FullNameExistsException.class)
    public ResponseEntity<ErrorResponseModel> handleFullNameExistsException(RuntimeException ex) {
        ErrorResponseModel errorResponseModel = ErrorResponseModel.builder()
                .title("fullName exists")
                .detail(ex.getLocalizedMessage())
